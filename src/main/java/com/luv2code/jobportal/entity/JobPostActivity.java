...
public class JobPostActivity {
    ...
    public JobPostActivity(Integer jobPostId, Users postedById, JobLocation jobLocation, JobCompany jobCompany, String jobDescription, Date postedDate, Boolean isActive, Boolean isSaved, String jobType, String salary, String remote, String jobTitle) {
        this.jobPostId = jobPostId;
        this.postedById = postedById;
        this.jobLocationId = jobLocation;
        this.jobCompanyId = jobCompany;
        this.descriptionOfJob = jobDescription;
